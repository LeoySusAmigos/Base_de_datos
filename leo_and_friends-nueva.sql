...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2026 at 07:11 AM
...
--
-- Indexes for table `leo_palabras_completadas`
--
ALTER TABLE `leo_palabras_completadas`
  ADD PRIMARY KEY (`completadoID`),
  ADD UNIQUE KEY `usuario_palabra` (`userID`,`palabraID`),
  ADD KEY `fk_palabras_palabra` (`palabraID`);
...
--
ALTER TABLE `leo_palabras`
  MODIFY `palabraID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `leo_palabras_completadas`
--
ALTER TABLE `leo_palabras_completadas`
  MODIFY `completadoID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `leo_palabras_completadas`
--
ALTER TABLE `leo_palabras_completadas`
  ADD CONSTRAINT `fk_palabras_palabra` FOREIGN KEY (`palabraID`) REFERENCES `leo_palabras` (`palabraID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_palabras_usuario` FOREIGN KEY (`userID`) REFERENCES `usuarios` (`userID`) ON DELETE CASCADE;
